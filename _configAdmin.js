...
const _adminConfig = {
  commands: {
    timer: ["!timer"],
    clearList: ["!clearlist", "!limparlista"],
    clearDone: ["!cleardone", "!limparfeitas"],
    clearUser: ["!clearuser", "!limparuser"],
  },
  responseTo: {
    EN: {
    ...
    PTBR: {
      timer: "Tempo de foco ajustado para {message} minutos",
      clearList: "Todas as tarefas foram apagadas",
      clearDone: "Todas as tarefas concluídas foram apagadas",
      clearUser: "Todas as tarefas de {message} foram apagadas",
    },
  },
};
