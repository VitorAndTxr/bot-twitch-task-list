...
const _styles = {
  ...
  cardBackgroundColor: "rgba(0, 0, 0, 0)", // rgba value https://rgbcolorpicker.com/

  // Username Styles
  usernameFontSize: "16px", // px value
  usernameColor: "rgb(242, 198, 109)", // hex value
  usernameFontWeight: "normal", // "normal", "lighter", "bold"

  // Task Styles
  taskFontSize: "14px", // px value
  taskFontColor: "rgb(255, 238, 205)", // hex value
